...
namespace ToDoApp
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Person() { Name = "Can", Id = "1" },
                new Person() { Name = "Bilal", Id = "2" },
                new Person() { Name = "Fırat", Id = "3" },
                new Person() { Name = "Uğur", Id = "4" }
            };

            List<Card> cards = new List<Card>()
            {
                 new Card(){ Title = "Student", Content = "Student Information", AssignedPerson = "Can", Dimension = CardDimensions.XL, Line = "TODO"},
                 new Card(){ Title = "Engineer", Content = "Engineer Information", AssignedPerson = "Bilal", Dimension = CardDimensions.M, Line = "IN PROGRESS"},
                 new Card(){ Title = "Teacher", Content = "Teacher Information", AssignedPerson = "Fırat", Dimension = CardDimensions.L, Line = "TODO"}
            };
        }
    }
   while (true)
